...
const words = ['çikolata', 'baklava', 'odun', 'bomba', 'süt', 'şimşek', 'yıldırım', 'patlat', 'savaş', 'kelime', 'yok et', 'bilmem', 'öldür', 'sonsuzluk', 'gerçek','discord','ozcanshow','votka','bot','sanal','salak','ekmek almaya git','çorba','uzay','haç','umre','pubg','dünya','evren','anne','bebek','kral','vezir','kardeşimbenim','youtube','facebook','ınstgram','hoca','radihoca'];
